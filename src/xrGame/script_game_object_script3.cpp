...
class_<CScriptGameObject> script_register_game_object2(class_<CScriptGameObject> &&instance)
{
	return std::move(instance)
		...
		.def("give_info_portion", SAFE_WRAP(&CScriptGameObject::GiveInfoPortion))
		.def("disable_info_portion", SAFE_WRAP(&CScriptGameObject::DisableInfoPortion))
		.def("give_game_news",
		     SAFE_WRAP((void (CScriptGameObject::*)(LPCSTR, LPCSTR, LPCSTR, int, int))(&CScriptGameObject::GiveGameNews)))
		.def("give_game_news",
		     SAFE_WRAP((void (CScriptGameObject::*)(LPCSTR, LPCSTR, LPCSTR, int, int, int))(&CScriptGameObject::GiveGameNews)))

		.def("give_talk_message",
		     SAFE_WRAP((void (CScriptGameObject::*)(LPCSTR, LPCSTR, LPCSTR))(&CScriptGameObject::AddIconedTalkMessage_old)))
		//old version, must remove!
		.def("give_talk_message2",
		     SAFE_WRAP((void (CScriptGameObject::*)(LPCSTR, LPCSTR, LPCSTR, LPCSTR))(&CScriptGameObject::AddIconedTalkMessage)))

		.def("has_info", SAFE_WRAP(&CScriptGameObject::HasInfo))
		.def("dont_has_info", SAFE_WRAP(&CScriptGameObject::DontHasInfo))

		.def("get_task_state", SAFE_WRAP(&CScriptGameObject::GetGameTaskState))
		.def("set_task_state", SAFE_WRAP(&CScriptGameObject::SetGameTaskState))
		.def("give_task", SAFE_WRAP(&CScriptGameObject::GiveTaskToActor), adopt<2>())
		.def("set_active_task", SAFE_WRAP(&CScriptGameObject::SetActiveTask))
		.def("is_active_task", SAFE_WRAP(&CScriptGameObject::IsActiveTask))
		.def("get_task", SAFE_WRAP(&CScriptGameObject::GetTask))

		.def("is_talking", SAFE_WRAP(&CScriptGameObject::IsTalking))
		.def("stop_talk", SAFE_WRAP(&CScriptGameObject::StopTalk))
		.def("enable_talk", SAFE_WRAP(&CScriptGameObject::EnableTalk))
		.def("disable_talk", SAFE_WRAP(&CScriptGameObject::DisableTalk))
		.def("is_talk_enabled", SAFE_WRAP(&CScriptGameObject::IsTalkEnabled))

		.def("enable_trade", SAFE_WRAP(&CScriptGameObject::EnableTrade))
		.def("disable_trade", SAFE_WRAP(&CScriptGameObject::DisableTrade))
		.def("is_trade_enabled", SAFE_WRAP(&CScriptGameObject::IsTradeEnabled))
		.def("enable_inv_upgrade", SAFE_WRAP(&CScriptGameObject::EnableInvUpgrade))
		.def("disable_inv_upgrade", SAFE_WRAP(&CScriptGameObject::DisableInvUpgrade))
		.def("is_inv_upgrade_enabled", SAFE_WRAP(&CScriptGameObject::IsInvUpgradeEnabled))

		.def("disable_show_hide_sounds", SAFE_WRAP(&CScriptGameObject::SetPlayShHdRldSounds))
		.def("inventory_for_each", SAFE_WRAP(&CScriptGameObject::ForEachInventoryItems))
		...
		// Tronex
		.def("iterate_inventory", SAFE_WRAP(&CScriptGameObject::IterateInventory))
		.def("iterate_ruck", SAFE_WRAP(&CScriptGameObject::IterateRuck))
		.def("iterate_belt", SAFE_WRAP(&CScriptGameObject::IterateBelt))
		.def("iterate_inventory_box", SAFE_WRAP(&CScriptGameObject::IterateInventoryBox))
		...
		.def("switch_to_trade", SAFE_WRAP(&CScriptGameObject::SwitchToTrade))
		.def("switch_to_upgrade", SAFE_WRAP(&CScriptGameObject::SwitchToUpgrade))
		.def("switch_to_talk", SAFE_WRAP(&CScriptGameObject::SwitchToTalk))
		...
		.def("hide_weapon", SAFE_WRAP(&CScriptGameObject::HideWeapon))
		.def("restore_weapon", SAFE_WRAP(&CScriptGameObject::RestoreWeapon))
		...
		.def("allow_sprint", SAFE_WRAP(&CScriptGameObject::AllowSprint))

		.def("set_start_dialog", SAFE_WRAP(&CScriptGameObject::SetStartDialog))
		.def("get_start_dialog", SAFE_WRAP(&CScriptGameObject::GetStartDialog))
		.def("restore_default_start_dialog", SAFE_WRAP(&CScriptGameObject::RestoreDefaultStartDialog))
		...
		.def("community_goodwill", SAFE_WRAP(&CScriptGameObject::GetCommunityGoodwill_obj))
		.def("set_community_goodwill", SAFE_WRAP(&CScriptGameObject::SetCommunityGoodwill_obj))

		.def("sympathy", SAFE_WRAP(&CScriptGameObject::GetSympathy))
		.def("set_sympathy", SAFE_WRAP(&CScriptGameObject::SetSympathy))

		//////////////////////////////////////////////////////////////////////////
		.def("profile_name", SAFE_WRAP(&CScriptGameObject::ProfileName))
		.def("character_name", SAFE_WRAP(&CScriptGameObject::CharacterName))
		.def("set_character_name", SAFE_WRAP(& CScriptGameObject::SetCharacterName))
		...
		.def("get_stmgun", SAFE_WRAP(&CScriptGameObject::get_stmgun))
#endif
#ifdef PROJECTOR_NEW
		.def("get_projector", SAFE_WRAP(&CScriptGameObject::get_projector))
#endif
		.def("get_hanging_lamp", SAFE_WRAP(&CScriptGameObject::get_hanging_lamp))
		.def("get_physics_shell", SAFE_WRAP(&CScriptGameObject::get_physics_shell))
		.def("get_holder_class", SAFE_WRAP(&CScriptGameObject::get_custom_holder))
		.def("get_current_holder", SAFE_WRAP(&CScriptGameObject::get_current_holder))
		//usable object
		.def("set_tip_text", SAFE_WRAP(&CScriptGameObject::SetTipText))
		.def("set_tip_text_default", SAFE_WRAP(&CScriptGameObject::SetTipTextDefault))
		.def("set_nonscript_usable", SAFE_WRAP(&CScriptGameObject::SetNonscriptUsable))
		...
		// inv box
		.def("is_inv_box_empty", SAFE_WRAP(&CScriptGameObject::IsInvBoxEmpty))
		.def("inv_box_closed", SAFE_WRAP(&CScriptGameObject::inv_box_closed))
		.def("inv_box_closed_status", SAFE_WRAP(&CScriptGameObject::inv_box_closed_status))
		.def("inv_box_can_take", SAFE_WRAP(&CScriptGameObject::inv_box_can_take))
		.def("inv_box_can_take_status", SAFE_WRAP(&CScriptGameObject::inv_box_can_take_status))

		// monster jumper
		.def("jump", SAFE_WRAP(&CScriptGameObject::jump))
		...
		.def("set_enable_movement_collision", SAFE_WRAP(&CScriptGameObject::set_enable_movement_collision))
		...
		.def("actor_look_at_point", SAFE_WRAP(&CScriptGameObject::ActorLookAtPoint))
		.def("actor_stop_look_at_point", SAFE_WRAP(&CScriptGameObject::ActorStopLookAtPoint))
		...
		.def("detach_vehicle", SAFE_WRAP(&CScriptGameObject::DetachVehicle))
		.def("get_attached_vehicle", SAFE_WRAP(&CScriptGameObject::GetAttachedVehicle))
#endif
#ifdef GAME_OBJECT_EXTENDED_EXPORTS
		.def("reset_bone_protections", SAFE_WRAP(&CScriptGameObject::ResetBoneProtections))
		.def("iterate_feel_touch", SAFE_WRAP(&CScriptGameObject::IterateFeelTouch))
		.def("get_luminocity_hemi", SAFE_WRAP(&CScriptGameObject::GetLuminocityHemi))
		.def("get_luminocity", SAFE_WRAP(&CScriptGameObject::GetLuminocity))
		.def("set_health_ex", SAFE_WRAP(&CScriptGameObject::SetHealthEx))
		...
		//For Ammo
		.def("ammo_get_count", SAFE_WRAP(&CScriptGameObject::AmmoGetCount))
		.def("ammo_set_count", SAFE_WRAP(&CScriptGameObject::AmmoSetCount))
		.def("ammo_box_size", SAFE_WRAP(&CScriptGameObject::AmmoBoxSize))
		//For Weapons
		...
		.def("iterate_installed_upgrades", SAFE_WRAP(&CScriptGameObject::IterateInstalledUpgrades))
		.def("weapon_in_grenade_mode", SAFE_WRAP(&CScriptGameObject::WeaponInGrenadeMode))
		// For CHudItem
		...
		// Phantom
		.def("phantom_set_enemy", SAFE_WRAP(&CScriptGameObject::PhantomSetEnemy))
		// Actor
		.def("set_character_icon", SAFE_WRAP(&CScriptGameObject::SetCharacterIcon))
		//casting
		.def("cast_Actor", SAFE_WRAP(&CScriptGameObject::cast_Actor))
		.def("cast_Car", SAFE_WRAP(&CScriptGameObject::cast_Car))
		.def("cast_Heli", SAFE_WRAP(&CScriptGameObject::cast_Heli))
		.def("cast_InventoryOwner", SAFE_WRAP(&CScriptGameObject::cast_InventoryOwner))
		.def("cast_InventoryBox", SAFE_WRAP(&CScriptGameObject::cast_InventoryBox))
		.def("cast_CustomZone", SAFE_WRAP(&CScriptGameObject::cast_CustomZone))
		.def("cast_TorridZone", SAFE_WRAP(&CScriptGameObject::cast_TorridZone))
		.def("cast_MosquitoBald", SAFE_WRAP(&CScriptGameObject::cast_MosquitoBald))
		.def("cast_ZoneCampfire", SAFE_WRAP(&CScriptGameObject::cast_ZoneCampfire))
		.def("cast_InventoryItem", SAFE_WRAP(&CScriptGameObject::cast_InventoryItem))
		.def("cast_CustomOutfit", SAFE_WRAP(&CScriptGameObject::cast_CustomOutfit))
		.def("cast_Helmet", SAFE_WRAP(&CScriptGameObject::cast_Helmet))
		.def("cast_Artefact", SAFE_WRAP(&CScriptGameObject::cast_Artefact))
		.def("cast_Ammo", SAFE_WRAP(&CScriptGameObject::cast_Ammo))
		.def("cast_Weapon", SAFE_WRAP(&CScriptGameObject::cast_Weapon))
		.def("cast_Knife", SAFE_WRAP(&CScriptGameObject::cast_Knife))
		.def("cast_WeaponMagazined", SAFE_WRAP(&CScriptGameObject::cast_WeaponMagazined))
		.def("cast_WeaponMagazinedWGrenade", SAFE_WRAP(&CScriptGameObject::cast_WeaponMagazinedWGrenade))
		...
		.def("cast_Missile", SAFE_WRAP(&CScriptGameObject::cast_Missile))
		.def("cast_Explosive", SAFE_WRAP(&CScriptGameObject::cast_Explosive))
		//Alundaio: END

		//Torch
		.def("set_color_animator", SAFE_WRAP(&CScriptGameObject::set_color_animator))
		.def("reset_color_animator", SAFE_WRAP(&CScriptGameObject::reset_color_animator))
#endif
		...
		.def("is_entity_alive", SAFE_WRAP(&CScriptGameObject::IsEntityAlive))
		.def("is_inventory_item", SAFE_WRAP(&CScriptGameObject::IsInventoryItem))
		.def("is_inventory_owner", SAFE_WRAP(&CScriptGameObject::IsInventoryOwner))
		.def("is_actor", SAFE_WRAP(&CScriptGameObject::IsActor))
		.def("is_custom_monster", SAFE_WRAP(&CScriptGameObject::IsCustomMonster))
		.def("is_weapon", SAFE_WRAP(&CScriptGameObject::IsWeapon))
		...
		.def("is_outfit", SAFE_WRAP(&CScriptGameObject::IsCustomOutfit))
		.def("is_helmet", SAFE_WRAP(&CScriptGameObject::IsHelmet))
		.def("is_scope", SAFE_WRAP(&CScriptGameObject::IsScope))
		.def("is_silencer", SAFE_WRAP(&CScriptGameObject::IsSilencer))
		.def("is_grenade_launcher", SAFE_WRAP(&CScriptGameObject::IsGrenadeLauncher))
		.def("is_weapon_magazined", SAFE_WRAP(&CScriptGameObject::IsWeaponMagazined))
		.def("is_space_restrictor", SAFE_WRAP(&CScriptGameObject::IsSpaceRestrictor))
		.def("is_stalker", SAFE_WRAP(&CScriptGameObject::IsStalker))
		.def("is_anomaly", SAFE_WRAP(&CScriptGameObject::IsAnomaly))
		.def("is_monster", SAFE_WRAP(&CScriptGameObject::IsMonster))
		...
		.def("is_trader", SAFE_WRAP(&CScriptGameObject::IsTrader))
		.def("is_hud_item", SAFE_WRAP(&CScriptGameObject::IsHudItem))
		//.def("is_food_item", &CScriptGameObject::IsFoodItem)
		.def("is_artefact", SAFE_WRAP(&CScriptGameObject::IsArtefact))
		.def("is_ammo", SAFE_WRAP(&CScriptGameObject::IsAmmo))
		...
		.def("is_weapon_gl", SAFE_WRAP(&CScriptGameObject::IsWeaponGL))
		.def("is_inventory_box", SAFE_WRAP(&CScriptGameObject::IsInventoryBox))
		...
		.def("set_slide_inertia_active", SAFE_WRAP(& CScriptGameObject::SetSlideInertiaActive))
		// OWA: surface friction from physics contacts (0 = airborne, ~0.5-2.0 on ground)
		.def("get_actor_ground_friction", SAFE_WRAP(& CScriptGameObject::GetActorGroundFriction))
		...
		.def("get_talking_npc", SAFE_WRAP(&CScriptGameObject::get_talking_npc))

		// demonized: get current scope texture
		.def("get_scope_ui", SAFE_WRAP(&CScriptGameObject::get_scope_ui))
		.def("set_scope_ui", SAFE_WRAP(&CScriptGameObject::set_scope_ui))
#endif
