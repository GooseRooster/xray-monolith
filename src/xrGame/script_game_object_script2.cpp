...
class_<CScriptGameObject> script_register_game_object1(class_<CScriptGameObject> &&instance)
{
	return std::move(instance)
		...
		.def("add_animation",
			...
			.def("play_body_animation", SAFE_WRAP(& CScriptGameObject::play_body_animation))
			.def("set_ik_enabled", SAFE_WRAP(& CScriptGameObject::set_ik_enabled))
			.def("get_ik_enabled", SAFE_WRAP(& CScriptGameObject::get_ik_enabled))
		...
		.def("set_fp_body_hidden", SAFE_WRAP(&CScriptGameObject::SetFPBodyHidden))
