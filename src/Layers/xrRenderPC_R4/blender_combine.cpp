...
void CBlender_combine::Compile(CBlender_Compile& C)
{
	...
	case 0: // combine
		...
		C.r_dx10Texture("s_probe_vol0", r2_T_probe_vol0);
		C.r_dx10Texture("s_probe_vol1", r2_T_probe_vol1);
		C.r_dx10Texture("s_probe_vol2", r2_T_probe_vol2);
	...
	case 4: // non-AA + DISTORTION
		...
		C.r_End();
		break;
	case 5: // OWA: Raymarched volumetric spotlight (Peak Volumetric Lights port)
